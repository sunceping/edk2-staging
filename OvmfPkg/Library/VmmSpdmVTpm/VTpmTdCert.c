...
)
{
  ...
  if (TdReportSize > sizeof(WorkArea->TdxWorkArea.SecTdxWorkArea.TdxTdReportInfo)) {
    return EFI_OUT_OF_RESOURCES;
  }
  
  CopyMem(WorkArea->TdxWorkArea.SecTdxWorkArea.TdxTdReportInfo, TdReport, TdReportSize);
